    ...
    <div className="m-6">
      ...
      <div className="hero bg-gray-800 text-white rounded-xl mb-4">
        <div className="hero-content text-center">
          <div className="max-w-md">
            ...
            <p className="py-6">Visualize a informação de performance académica dos alunos através dos departamentos, cursos e cadeiras da Universidade de Aveiro.</p>
          </div>
        </div>
      </div>
      ...
      {/* /* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4 place-items-center">
          ...
          Deti é o melhor <FaSmile className="smile-emoji inline-block size-4 transform transition-transform duration-500 hover:rotate-[360deg] hover:scale-125" />
            </div>
          </div>
        </div>
      ...
      <div className="card bg-gray-800 shadow-xl text-white">
        <div className="card-body p-0">
          <h2 className="card-title">Como começar</h2>
          <div className="steps steps-vertical">
            <div className="step step-success">Selecionar o nivel de visão (Universidade/Departamento/Curso/Cadeira)</div>
            <div className="step step-success">Use os filtros para afunilar os dados</div>
            <div className="step step-success">Explore a interação entre as visualizações</div>
          </div>
        </div>
      </div>
    </div>
